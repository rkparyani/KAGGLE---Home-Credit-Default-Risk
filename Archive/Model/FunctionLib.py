...
def GetScaledModelwithbestparams(nameOfScaler,LR_best_params,AB_best_params,GB_best_params,RF_best_params,CART_best_params,KNN_best_params):
    if nameOfScaler == 'standard':
        scaler = StandardScaler()
    elif nameOfScaler =='minmax':
        scaler = MinMaxScaler()
    pipelines = []
    pipelines.append((nameOfScaler+'LR'+'CW'  , Pipeline([('Scaler', scaler),('LR'  , LogisticRegression(**LR_best_params))])))
    pipelines.append((nameOfScaler+'LDA' , np.nan))
    pipelines.append((nameOfScaler+'KNN' , Pipeline([('Scaler', scaler),('KNN' , KNeighborsClassifier(**KNN_best_params))])))
    pipelines.append((nameOfScaler+'CART'+'CW', Pipeline([('Scaler', scaler),('CART', DecisionTreeClassifier(**CART_best_params))])))
    pipelines.append((nameOfScaler+'NB'  ,np.nan))
    #pipelines.append((nameOfScaler+'SVM'+'CW' , Pipeline([('Scaler', scaler),('SVM' , SVC(class_weight='balanced'))])))
    pipelines.append((nameOfScaler+'AB'  , Pipeline([('Scaler', scaler),('AB'  , AdaBoostClassifier(**AB_best_params))])  ))
    pipelines.append((nameOfScaler+'GBM' , Pipeline([('Scaler', scaler),('GMB' , GradientBoostingClassifier(**GB_best_params))])  ))
    pipelines.append((nameOfScaler+'RF'+'CW'  , Pipeline([('Scaler', scaler),('RF'  , RandomForestClassifier(**RF_best_params))])  ))
    pipelines.append((nameOfScaler+'ET'+'CW'  , np.nan))    
    return pipelines 